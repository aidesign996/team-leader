...
<p align="center"><img src="assets/experience.zh-hant.png" width="360" alt="目標指導選擇，實際結果分別用於修正當前工作與修訂舊經驗。"></p>
...
<p align="center"><img src="assets/files.zh-hant.png" width="420" alt="共同規則、崗位職責、有效約定、情境經驗和當前狀態，各有固定入口。"></p>
...
圖中是隨包模板的知識分工；已有項目可以沿用自己的有效入口。案例留下當時的條件、選擇理由、實際結果和適用邊界，後續有新證據就更新原記錄，無關或重複內容不必另存一份。
